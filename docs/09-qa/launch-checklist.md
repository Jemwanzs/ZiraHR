...
## Post-launch
- [~] Register with Google Search Console and submit the sitemap. **In progress as of 2026-08-13** — ownership verified (HTML tag method) and sitemap submitted; indexing not yet confirmed (sitemap fetch was still pending, manual "Request Indexing" hit Search Console's daily quota). Full process, diagnosis, and what to check next: `05-seo/search-console-and-indexing.md`.
