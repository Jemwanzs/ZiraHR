...
- **Canonical URL**: self-referencing canonical on every page, locale-aware (`https://softhr.vercel.app/fr/payroll` canonicalizes to itself, not to the English version).
